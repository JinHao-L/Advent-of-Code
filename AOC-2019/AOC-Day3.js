...
function write_route(wire) {
  let x = 0;
  let y = 0;
  let route = [];
  
  for(let i = 0; i < wire.length; i++) {
    direction = wire[i].slice(0,1);
    distance = parseInt(wire[i].slice(1,4));
...
const route1 = write_route(wire1);
const route2 = write_route(wire2);
console.log(route1);
console.log(route2);
...
console.log("Part2: " + cmp_route(route1, route2));